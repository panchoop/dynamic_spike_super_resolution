### This particular simulation allows particles to live indefenitively
# without erasing when arriving to the boundary. Simulating now with a bit closer particles
